...
class TestCourseService:
    ...
    def test_create_course_raises_on_invalid(self, service):
...
class TestQuizService:
    ...
    def test_create_quiz_raises_with_empty_title(self, service):
    ...
    def test_calculate_score_all_correct(self, service):
        q = Quiz(id="q1")
    ...
    def test_calculate_score_partial(self, service):
        q = Quiz(id="q1")
        q1 = QuizQuestion(id="a", question_text="Q1", correct_answer="A", points=1.0)
        q2 = QuizQuestion(id="b", question_text="Q2", correct_answer="B", points=2.0)
        q.questions = [q1, q2]
...
class TestLessonService:
    ...
    def test_create_lesson_raises_on_empty_title(self, service):
